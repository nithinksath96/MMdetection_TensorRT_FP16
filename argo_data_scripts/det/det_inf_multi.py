...
def parse_args():
    ...
    parser.add_argument('--fast-birth-tracks', action='store_true', default=True)
    parser.add_argument('--fast-kill-tracks', action='store_true', default=True)
    parser.add_argument('--fps', type=float, default=30)
...
def main():
    ...
    caches = [
        join(opts.exp_dir, 'ArgoVerse1.1-c3-eta0/output/mrcnn50_nm_s0.5/val/results_ccf.pkl'),
        join(opts.exp_dir, 'ArgoVerse1.1-c3-eta0/output/mrcnn50_nm_s1.0/val/results_ccf.pkl'),
    ]
