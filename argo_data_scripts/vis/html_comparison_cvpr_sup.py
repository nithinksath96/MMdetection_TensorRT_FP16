...
names = [
    ...
    'A: Det Fast<br>B: Det Opt + Alg 1',
    'A: Det Opt + Alg 1<br>B: A + Forecasting',
    'A: Det Opt + Alg 1 + Forecasting<br>B: A + Infinite GPUs',
    'A: Det + Visual Tracking + Forecasting<br>B: A + Simulated Fast Tracking (x2)',
...
dirs = [
    ...
    join(data_dir, 'Exp', data_cfg, 'visf', 'rt_retina50_s0.2_pkt-vs-srt_mrcnn50_nm_ds_s0.5_pkt', split),
    join(data_dir, 'Exp', data_cfg, 'visf-0.58', 'srt_mrcnn50_nm_ds_s0.5_pkt-vs-pps_mrcnn50_nm_ds_s0.75_fba_iou_lin_pkt', split),
    join(data_dir, 'Exp', data_cfg, 'visf-0.58', 'pps_mrcnn50_nm_ds_s0.75_fba_iou_lin_pkt-vs-pps_mrcnn50_nm_inf_s0.75_3_stitched_pkt', split),
    join(data_dir, 'Exp', data_cfg, 'visf-0.58', 'pps_dat_mrcnn50_nm_d5_s0.75_pkt-vs-pps_dat_mrcnn50_nm_d15_track-pf-2_s0.75_pkt', split),
    # join(data_dir, 'Exp', data_cfg, 'visf-0.58', 'htc_dconv2_ms_nm_s1.0-vs-pps_mrcnn50_nm_ds_s0.75_fba_iou_lin_pkt', split),
    # join(data_dir, 'Exp', data_cfg, 'visf-0.58', 'htc_dconv2_ms_nm_s1.0-vs-pps_mrcnn50_nm_inf_s0.75_3_stitched_pkt', split),
]
