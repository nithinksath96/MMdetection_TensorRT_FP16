...
names = [
    'Annotation',
    'Mask R-CNN R50 Scale 0.5',
    'MRCNN + Schedule + Assoc + Forecast',
    'MRCNN + Tracking + Forecast',
]

dirs = [
    join(data_root, 'coco_fmt/vis/htc_dconv2_ms_' + split),
    join(data_dir, 'Exp/ArgoVerse/vis/srt_mrcnn_r50_nm_ds/s0.5_' + split),
    join(data_dir, 'Exp/ArgoVerse/vis/srt_mrcnn_r50_nm_ds_fba_iou_linear/s0.5_' + split),
    join(data_dir, 'Exp/ArgoVerse/vis/rt_dat_mrcnn50_nm_track_only_s0.5_d15_itp/' + split),
]
