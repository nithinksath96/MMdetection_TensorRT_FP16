...
dirs = [
    ...
    join(data_dir, 'Exp', 'ArgoVerse1.1-c3-eta0', 'vis', 'mrcnn50_nm_s0.5', split),
    join(data_dir, 'Exp', 'ArgoVerse1.1-c3-eta0', 'vis', 'mrcnn50_nm_s1.0', split),
    join(data_dir, 'Exp', 'ArgoVerse1.1', 'vis-inf', 'imd1_mrcnn50_nm_s0.5_s1.0', split),
]
