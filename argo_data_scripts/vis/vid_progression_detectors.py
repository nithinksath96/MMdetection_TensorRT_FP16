...
out_dir = mkdir2(join(data_dir, 'Exp/ArgoVerse1.1/vid/det'))

text = [
    ['Accurate Detector (Offline)', 'Excellent but not practical (AP 38.0)'],
    ['Accurate Detector (Real-Time)', 'Latency too high (AP 6.2)'],
    ['Fast Detector (Real-Time)', 'Detection too noisy (AP 6.0)'],
    ['Optimized Detector (Real-Time)', 'Balanced accuracy and latency (AP 12.0)'],
]
...
dirs = [
    ...
    join(data_dir, 'Exp/ArgoVerse1.1/visf-th0.5/rt_retina50_s0.2_pkt/val'),
    join(data_dir, 'Exp/ArgoVerse1.1/visf-th0.5/rt_mrcnn50_nm_s0.5_pkt/val'),
]
