...
names = [
    ...
    'A: Offline SOTA<br>B: Best Streaming Solution',
]
...
dirs = [
    ...
    join(data_dir, 'Exp', data_cfg, 'visf-0.58', 'srt_mrcnn50_nm_ds_s0.5-vs-pps_mrcnn50_nm_ds_s0.75_fba_iou_lin', split),
    join(data_dir, 'Exp', data_cfg, 'visf-0.58', 'pps_mrcnn50_nm_ds_s0.75_fba_iou_lin-vs-pps_mrcnn50_nm_inf_s0.75_3_stitched', split),
    join(data_dir, 'Exp', data_cfg, 'visf-0.58', 'pps_dat_mrcnn50_nm_d5_s0.75-vs-pps_dat_mrcnn50_nm_d15_track-pf-2_s0.75', split),
    join(data_dir, 'Exp', data_cfg, 'visf-0.58', 'htc_dconv2_ms_nm_s1.0-vs-pps_mrcnn50_nm_inf_s0.75_3_stitched', split),
]
