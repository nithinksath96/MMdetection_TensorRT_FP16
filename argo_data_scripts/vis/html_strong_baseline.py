...
names = [
    'Annotation',
    'MRCNN R50 S0.5 + Scheduling',
    'MRCNN R50 S0.5 + Scheduling + IoU Assoc + Lin Forecast',
    'MRCNN R50 S0.5 + Tracking (det stride 15) + Lin Forecast',
]
