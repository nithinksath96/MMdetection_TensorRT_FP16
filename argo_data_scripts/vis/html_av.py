...
dirs = [
    ...
    join(data_dir, 'Exp/ArgoVerse/vis/dat_mrcnn50_nm_s0.5_s0.25_d3/' + split),
    join(data_dir, 'Exp/ArgoVerse/vis/dat_mrcnn50_nm_s0.5_s0.25_d15/' + split),
    join(data_dir, 'Exp/ArgoVerse/vis/dat_mrcnn50_nm_s0.5_s0.25_d30/' + split),
    join(data_dir, 'Exp/ArgoVerse/vis/dat_mrcnn50_nm_plus_det_s0.5_s0.25_d3/' + split),
    join(data_dir, 'Exp/ArgoVerse/vis/dat_mrcnn50_nm_plus_det_s0.5_s0.25_d15/' + split),
    join(data_dir, 'Exp/ArgoVerse/vis/dat_mrcnn50_nm_plus_det_s0.5_s0.25_d30/' + split),
]
