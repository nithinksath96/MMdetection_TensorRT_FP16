...
names = [
    ...
    'A: Det Fast<br>B: Det Optimized',
    'A: Det Optimized<br>B: Det Optimized + Scheduling + Forecasting',
    'A: Det Optimized + Scheduling + Forecasting<br>B: Det + Visual Tracking + Forecasting',
]

dirs = [
    join(data_dir, 'Exp', data_cfg, 'visf', 'mrcnn101_nm_s1.0-vs-rt_mrcnn101_nm_cpupre_s1', split),
    join(data_dir, 'Exp', data_cfg, 'visf', 'rt_mrcnn101_nm_cpupre_s1-vs-rt_retina50_s0.2', split),
    join(data_dir, 'Exp', data_cfg, 'visf', 'rt_retina50_s0.2-vs-rt_mrcnn50_nm_s0.5', split),
    join(data_dir, 'Exp', data_cfg, 'visf', 'rt_mrcnn50_nm_s0.5-vs-pps_mrcnn50_nm_ds_s0.5_fba_iou_lin', split),
    join(data_dir, 'Exp', data_cfg, 'visf', 'pps_mrcnn50_nm_ds_s0.5_fba_iou_lin-vs-pps_dat_mrcnn50_nm_d15_s0.5_fba_iou_lin', split),
]
